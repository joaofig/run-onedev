...
:callcommand
if [%_COMMAND%]==[console] (
    %_WRAPPER_EXE% -c "%_WRAPPER_CONF%" wrapper.logfile.loglevel=NONE wrapper.console.title="OneDev Enable Internal Login" wrapper.name=onedev_enable-internal-login wrapper.displayname="OneDev Enable Internal Login" wrapper.description="OneDev Enable Internal Login" -- enable-internal-login %_PARAMETERS%
